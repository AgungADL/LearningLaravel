...
<div class="p-6 bg-white shadow-md rounded-lg">
    <div class="mb-8">
        ...
        <p class="text-gray-600">Selamat datang di dashboard admin. Anda memiliki akses penuh ke semua fitur.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <!-- Total Kasir -->
        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
            <h3 class="text-lg font-semibold text-gray-700">Kasir</h3>
            <p class="text-2xl font-bold text-black">{{ $totalCashiers }}</p>
        </div>
    </div>
